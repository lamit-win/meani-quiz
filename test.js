$(document).ready(function () {
	...
	*/
	...
	function scorePage(){
		...
		$("#gameArea").append('<a class="btn btn-outline-info" href="index.html">LV.1</a>');
		$("#gameArea").append('<a class="btn btn-outline-info" href="lv2.html">LV.2</a>');
		$("#gameArea").append('<div id="wordBox">Đúng: <b>'+score+'</b> ('+totalQuestions+')</div>');
		gamePosition=4;					
	}//scorePage
